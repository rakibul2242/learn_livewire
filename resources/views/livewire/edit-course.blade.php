<div class="max-w-4xl mx-auto px-4 py-10">
    <h2 class="text-3xl font-bold text-center border-b pb-4 mb-10">
        Edit <span class="text-blue-500">Course</span>
    </h2>

    <form wire:submit="update" class="space-y-6 shadow bg-white rounded p-6" enctype="multipart/form-data">
        <div>
        ...
        <div>
            ...
            @elseif($existingImage)
                <div class="mt-3">
                    <img src="{{ asset('storage/' . $existingImage) }}" class="h-32 object-cover rounded shadow">
                </div>
            @endif
        </div>
        ...
        <div class="text-right mt-4">
            <div class="bg-blue-600 text-white rounded hover:bg-blue-700 transition inline-block">
                <button type="submit" class="cursor-pointer px-4 py-2" wire:loading.attr="disabled" wire:target="update">
                    Update Course
                </button>
                <div wire:loading wire:target="update" class="inline-block pr-4 align-middle">
